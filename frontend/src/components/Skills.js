...
const Skills = () => {
    return <div className="skills_inner grid grid-cols-2 gap-x-32 gap-y-12 mt-16">
        ...
        <article className='flex justify-start items-center align-end gap-4 border-b-8 border-[#660708] w-full pb-3'> <img src={css} alt="css logo" width="70x"/> <h3  className='text-center pl-20 pt-2 text-5xl'>CSS3</h3></article>
        ...
        <article className='flex justify-start items-center align-end gap-4 border-b-8 border-[#660708] w-full pb-3'> <img src={figma} className='pl-3' alt="figma logo" width="50px"/> <h3  className='text-center pl-24 pt-2 text-5xl'>FIGMA</h3></article>
    </div>
  }
